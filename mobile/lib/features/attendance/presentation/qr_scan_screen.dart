...
/// Full-screen QR scanner for CLAMS badges ("CLAMS:W-0001"). Pops with the
/// decoded string (or null if cancelled). Aadhaar QRs use the dedicated
/// zxing-cpp scanner in features/aadhaar instead.
